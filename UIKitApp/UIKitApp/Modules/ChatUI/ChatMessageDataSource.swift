...
class ChatMessageDataSource {
    ...
    private var messages = [
        ...
        ChatMessage(text: "Have you realised that the classes are more enticing with the new ways of teaching? Our teachers have also become more creative with their approaches.", isIncoming: true, date: "27/06/2023".asDate()),
        ChatMessage(text: "I have seen that too. These online classes are very good for all of us. We learn something new every day even though there’s a pandemic.", isIncoming: false, date: "27/06/2023".asDate()),
        ChatMessage(text: "But I have some problems too with online classes.", isIncoming: true, date: "09/06/2023".asDate()),
        ChatMessage(text: "What problems are you facing during online classes?", isIncoming: false, date: "28/06/2023".asDate()),
        ...
        ChatMessage(text: "Sure no problem, goodbye 😍😎", isIncoming: false, date: "29/06/2023".asDate()),
        ChatMessage(text: "Goodbye, it was nice talking to you.", isIncoming: true, date: "29/06/2023".asDate()),
        ChatMessage(text: "Same here, see you soon !!", isIncoming: false, date: "29/06/2023".asDate())
    ]
